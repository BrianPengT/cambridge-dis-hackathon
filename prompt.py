...
skeptic = run_agent("gpt-4o-mini", SKEPTIC_PROMPT, case)
factchecker = run_agent("gpt-4o-mini", FACTCHECKER_PROMPT, case)
commonsense = run_agent("gpt-4o-mini", COMMONSENSE_PROMPT, case)
