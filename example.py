...
def debate(topic: str, model: str = "gpt-4.1-mini") -> None:
    pro_system = (
        "You are Agent Pro. Argue strongly in favor of the proposition. "
        "Be concise, factual, and cite 2-3 key points."
    )
    con_system = (
        "You are Agent Con. Argue strongly against the proposition. "
        "Be concise, factual, and cite 2-3 key points."
    )
    judge_system = (
        "You are the Judge. Compare both arguments for clarity, evidence, and logic. "
        "Declare a winner and explain briefly."
    )
...
# Example usage of the debate:
debate("AI in healthcare should require strict regulation.", model="gpt-4.1-mini")
